...
使用 **ESP32S3 N16R8** , 带 TF 卡支持与摄像头 ( OV2640 ) 支持. 如需修改 / 关闭相关功能请自行编辑代码.

项目配置需要 **适当增加缓冲区** , 我个人将很多网络相关的 buf_size 都提高到了 16384 . 业务任务均放在 **SPIRAM** 上运行.
...
通过一个 **10Kohm** 电阻 *直接* 连到 **IO42** . 电阻的作用是限流放损坏.
...
本仓库部分代码参考 *ChatGPT* 结果. 主要为 *ws.c* 架构优化环节.
